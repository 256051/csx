...
namespace Ms.Extensions.Logging
{
    ...
    internal static class ActivityExtensions
    {
        public static string GetSpanId(this Activity activity)
        {
            ...
            {
                case (ActivityIdFormat.Hierarchical): return activity.Id??"";
                case (ActivityIdFormat.W3C): return activity.SpanId.ToHexString();
        ...
        public static string GetTraceId(this Activity activity)
        {
            switch (activity.IdFormat)
            {
                case (ActivityIdFormat.Hierarchical): return activity.RootId ?? "";
                case (ActivityIdFormat.W3C): return activity.TraceId.ToHexString();
                default: return string.Empty;
            };
        }
        ...
        public static string GetParentId(this Activity activity)
        {
            switch (activity.IdFormat)
            {
                case (ActivityIdFormat.Hierarchical): return activity.ParentId ?? "";
                case (ActivityIdFormat.W3C): return activity.ParentSpanId.ToHexString();
                default: return string.Empty;
            };
        }
    }

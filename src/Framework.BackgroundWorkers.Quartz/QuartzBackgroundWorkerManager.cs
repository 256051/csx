...
{
    public class QuartzBackgroundWorkerManager : IBackgroundWorkerManager, ISingleton,IReplace
    {
        ...
        {
            AsyncHelper.RunSync(() => ScheduleJobAsync(worker));
        }

        protected virtual async Task ScheduleJobAsync(IBackgroundWorker worker)
        {
